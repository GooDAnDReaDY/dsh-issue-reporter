...
const zh = {
    ...
    function SettingsCard({ ctx }) {
      ...
      const renderPlugin = (plugin) => h('div', { key: plugin.moduleName + (plugin.presetId || ''), style: { display: 'flex', justifyContent: 'space-between', gap: 8, alignItems: 'center', padding: '8px 0', borderBottom: '1px solid var(--dsw-alias-border-l1)' } }, [
        h('div', null, [
