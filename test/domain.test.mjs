...
test('redacts credentials, private paths, urls, emails, LAN IPs, JWTs and AI keys', () => {
  const value = 'token: abc123 password=secret https://user:pass@example.test /home/alice/project a@b.example 10.23.45.67 10.0.0.50 AIzaSyD3x94jFl892Kls9_1204857682910 eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIn0.dozjgNryP4J3jVmNHl0w5N_XgL0n3I9PlF2r1_6'
  ...
  assert.equal(result.text.includes('10.23.45.67'), false)
